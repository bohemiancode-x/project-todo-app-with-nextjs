...
export default function Navbar() {
  ...
  return (
    <div className={theme === 'light' ? 'bg-bgmobilelight md:bg-bgdesktoplight bg-cover h-[25%]' : `bg-bgmobiledark md:bg-bgdesktopdark bg-cover h-[25%]`}>
      <div className='md:w-[50%] md:m-auto'>
        <div className='flex justify-between px-6 md:px-0 pt-16 items-center'>
        ...
        <form onSubmit={(e) => handleForm(e)} className='flex gap-3 items-center mx-6 md:mx-0 px-4 py-4 rounded-lg md:mt-8 mt-5 bg-white dark:bg-darkVddBlue'>
